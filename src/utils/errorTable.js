const errorTable = [
  ...
  { code: 4099, message: '연도, 학기, 혹은 Timetable 이름이 주어지지 않았습니다.' },
  { code: 4100, message: '강의 객체가 주어지지 않았습니다.' },
  { code: 4101, message: '강의 객체에 id 속성이 없습니다.' },
  { code: 4102, message: 'Course number 혹은 lecture number는 수정할 수 없습니다.' },
  ...
  { code: 4106, message: 'Color 문자열이 올바른 hex 색상이 아닙니다. 올바른 색상 "#FFFFFF"' },
  { code: 8192, message: 'API key가 올바르지 않습니다.' },
  { code: 8193, message: '로그인이 필요하지만 user token이 주어지지 않았습니다.' },
  ...
  { code: 12292, message: '이미 해당 course number와 lecture number의 강의가 존재합니다.' },
  ...
  { code: 12302, message: '(서버 내부 전용) 유저에게 등록된 fcm key가 없습니다.' },
